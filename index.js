...
const config = {
    A187: 'Bot do Icarokkk🤖',
    instagram: 'https://www.instagram.com/hilorena20s/',
    nomer: 'wa.me/+5579988645802',
    aktif: 'Icaro',
    youtube: 'https://youtube.be',
    whatsapp: 'https://chat.whatsapp.com/EQtvfPObFTGITMdUrP6Oyg',
   ...
   case 'fb':
           fb(value)
               .then(data => {
                   ...
                   let hasil = `Pilih resolusi nya kakak \n\n\n HD ${resultHD} \n\n\n SD ${resultSD}`
                   client.sendMessage(id, hasil, MessageType.text)
               })
               .catch(err => {
                   console.log(err)
 ...
 case 'infogempa':
   ...
   case 'chord':
           chord(value)
               .then(data => {
                   const { result } = data
                   let hasil = `Nih chord lagu *${value}* kakak 🎵\n\n  _${result}_ `
                   client.sendMessage(id, hasil, MessageType.text)
               })
               .catch(err => {
                   console.log(err)
